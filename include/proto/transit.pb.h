...
class Transit_Node PROTOBUF_FINAL :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 osm_connecting_way_id() const;
  void set_osm_connecting_way_id(::PROTOBUF_NAMESPACE_ID::uint64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint64 _internal_osm_connecting_way_id() const;
  void _internal_set_osm_connecting_way_id(::PROTOBUF_NAMESPACE_ID::uint64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint64 osm_connecting_way_id_;
...
inline void Transit_Node::clear_osm_connecting_way_id() {
  osm_connecting_way_id_ = PROTOBUF_ULONGLONG(0);
  _has_bits_[0] &= ~0x00000080u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Transit_Node::_internal_osm_connecting_way_id() const {
  return osm_connecting_way_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Transit_Node::osm_connecting_way_id() const {
...
inline void Transit_Node::_internal_set_osm_connecting_way_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _has_bits_[0] |= 0x00000080u;
  osm_connecting_way_id_ = value;
}
inline void Transit_Node::set_osm_connecting_way_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
