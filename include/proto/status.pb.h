...
inline void Status::clear_osm_changeset() {
  if (_internal_has_osm_changeset()) {
    has_osm_changeset_.osm_changeset_ = PROTOBUF_ULONGLONG(0);
    clear_has_has_osm_changeset();
  }
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 Status::_internal_osm_changeset() const {
  if (_internal_has_osm_changeset()) {
    return has_osm_changeset_.osm_changeset_;
  }
  return PROTOBUF_ULONGLONG(0);
}
inline void Status::_internal_set_osm_changeset(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  if (!_internal_has_osm_changeset()) {
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Status::osm_changeset() const {
  // @@protoc_insertion_point(field_get:valhalla.Status.osm_changeset)
  return _internal_osm_changeset();
}
inline void Status::set_osm_changeset(::PROTOBUF_NAMESPACE_ID::uint64 value) {
